...
```toml
{{#include ../../examples_zh-CN/01_04_async_await_primer/Cargo.toml:9:10}}
```
...
```rust,no_run
{{#include ../../examples_zh-CN/01_04_async_await_primer/src/lib.rs:block_on_each}}
```
...
```rust,no_run
{{#include ../../examples_zh-CN/01_04_async_await_primer/src/lib.rs:block_on_main}}
```
